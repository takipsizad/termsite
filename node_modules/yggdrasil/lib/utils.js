...
const utils = {
     ...
     */
    call: async function (host, path, data, agent) {
        const resp = await node_fetch_1.default(`${host}/${path}`, { agent, body: JSON.stringify(data), headers, method: 'POST' });
    ...
    callbackify: function (f, maxParams) {
